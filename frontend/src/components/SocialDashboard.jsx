    ...
    return (
        <div style={{ maxWidth: '700px', margin: '0 auto', padding: '1rem' }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '2rem' }}>
                ...
                {/* Right: Pending Friend Requests */}
                <div>
                    <section style={{ background: 'rgba(255,255,255,0.05)', padding: '1.5rem', borderRadius: '12px' }}>
                        <h3 style={{ marginTop: 0 }}>Pending Friend Requests ({requests.length})</h3>
                        <div style={{ display: 'flex', flexDirection: 'column', gap: '10px' }}>
                    ...
                    <section style={{ marginTop: '2rem', background: 'rgba(102,126,234,0.1)', padding: '1.5rem', borderRadius: '12px', border: '1px solid rgba(102,126,234,0.2)' }}>
                        <h3 style={{ marginTop: 0 }}>💡 Tip</h3>
                        <p style={{ color: '#a0aec0', fontSize: '0.9rem', margin: 0 }}>
                            Check the <strong>Online Now</strong> panel on the home page to see who's playing and challenge them to a match!
                        </p>
                    </section>
                </div>
            </div>
